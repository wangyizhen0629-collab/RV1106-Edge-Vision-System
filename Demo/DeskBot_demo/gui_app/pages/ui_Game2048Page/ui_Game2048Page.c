...
///////////////////// SCREEN init ////////////////////
void ui_Game2048Page_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Game2048BtnM, &lv_font_montserrat_20, 0);
    ...
    lv_obj_align(new_game_btn, LV_ALIGN_RIGHT_MID, -5, -50);
    ...
    lv_obj_set_style_text_font(new_game_btn_label, &lv_font_montserrat_20, 0);
    ...
    lv_obj_align(return_btn, LV_ALIGN_RIGHT_MID, -5, 50);
    lv_obj_set_size(return_btn,85,35);
    ...
    lv_obj_set_style_text_font(return_btn_label, &lv_font_montserrat_20, 0);
